...
public static void emailNewAppointmentByStaff(Appointment appointment,Patient patient,Doctor doctor) {
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO,
				InternetAddress.parse(patient.getEmail()));
			message.setSubject("You have a new appointment created by staff");
			message.setText("Dear, "+patient.getName()
				+ "\n\n Our staff made a new appointment for you."
				+ "\nAppointment ID : "+appointment.getId()
				+ "\nDoctor : "+doctor.getName()+" "+doctor.getSurname()
				+ "\nPatient : "+patient.getName()+" "+patient.getSurname()
				+ "\nSymptom : "+appointment.getSymptom()
				+ "\nAppointment Date : "+appointment.getDate()
				+ "\n\nPlease come in 20 minutes before your appointment"
				+ "\nYou has no account, don't for get to register account in myHostpital.com for your benefits");
