...
<div class="container-fluid">
	...
	<div class="col-sm-4 col-md-offset-4">
		<c:if test="${ error =='-2'}">
			<div class="alert alert-danger">Username already exists, please
				try again.</div>
		</c:if>
		<c:if test="${ error =='-3'}">
			<div class="alert alert-danger">SSN already exists, please try
				again.</div>
		</c:if>
		<c:if test="${ error =='-4'}">
			<div class="alert alert-danger">Email already exists, please
				try again.</div>
		</c:if>
		<form:form id="register-patient" method="post"
			action="register-patient" commandName="patient"
			...
			<fieldset class="form-group inline">
				<div class="input-group">
					...
					<form:input path="ssn" type="text" class="form-control"
						placeholder="" aria-describedby="basic-addon1" maxlength="13" />
					<br>
			...
			<fieldset class="form-group inline">
				<div class="input-group">
					...
					<form:input path="surname" type="text" class="form-control"
						placeholder="Surname" aria-describedby="basic-addon1" />
					<br>
			...
			<fieldset class="form-group inline">
				<div class="input-group">
					<label>Gender </label>
					<form:radiobutton path="gender" value="M" style="margin-left:20px;" />
					Male
					<form:radiobutton path="gender" value="F" style="margin-left:20px;" />
					Female
			...
			<fieldset class="form-group inline">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1">Telephone
						Number</span>
					<form:input path="tel" type="text" class="form-control"
						placeholder="Tel." aria-describedby="basic-addon1" maxlength="10"/>
					<br>
