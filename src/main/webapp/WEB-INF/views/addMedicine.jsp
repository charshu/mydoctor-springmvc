...
<div class="container fluid">
	...
	<form:form id="addMedicineForm" method="post" action="add-medicine"
		...
		<form:select path="id">
			<c:forEach items="${medicineBeanOption}" var="medicineBeanOption">
			<form:options items="${medicineBeanOption}" />
			</c:forEach>
		</form:select>
		...
		<div class="row pad pull-right">
			<div class="col-xs-3 ">
				<a href="/see-medicine-list" class="btn btn-success pull-right">See
					Medicine List</a>
			</div>
